...
module.exports = (client, message, args, cmd, prefix) => {
    ...
    if (!args[0])
      return message.reply(new Discord.MessageEmbed()
        ...
        .setDescription(`PREFIX: \`${prefix}\` | [Chauvin's Community](https://discord.gg/b2Cgk3trGV)\n\n*Enter the right Category, to see help for them* Example: \`${prefix}help voice\`\n[\`INVITE ME\`](https://discord.com/api/oauth2/authorize?client_id=914037041673682995&permissions=8&scope=bot) | [\`Support Server\`](https://discord.gg/b2Cgk3trGV) | [\`Website\`]( ) | Developer: \`Chauvin#4522\``)
    ...
    switch (args[0].toLowerCase()) {
      case "general":
        return message.reply(new Discord.MessageEmbed()
          ...
          .addField(`\`${prefix}add\``, "> *[Invite](https://discord.com/api/oauth2/authorize?client_id=914037041673682995&permissions=8&scope=bot) the Bot!*", true)
          .addField(`\`${prefix}support\``, "> *Sends you a Link for the [SUPPORT SERVER](https://discord.gg/b2Cgk3trGV) of the Bot!*", true)
          ...
          .addField(`\`${prefix}tutorial\``, "> *Gives you a Link to the [Support Server](https://discord.gg/b2Cgk3trGV)*", true)
          .addField(`\`${prefix}source\``, "> *Gives you a Link to the [Source Code on Github](https://github.com/FarmerChauvin/ChauvinAutoChat)*", true)
