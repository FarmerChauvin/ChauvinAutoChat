...
module.exports = (client, message, args, cmd, prefix) => {
  if (cmd === "ping") {
    ...
    message.reply(
      ...
      .setDescription("[\`Join to Support Server\`](https://discord.gg/b2Cgk3trGV) to gain help!)")
    )
    return;
    ...
    cpuStat.usagePercent(function (e, percent, seconds) {
      try {
        ...
        const botinfo = new Discord.MessageEmbed()
          ...
          .setFooter("Coded by:    Chauvin#4522");
    ...
    return message.reply(new Discord.MessageEmbed()
      .setColor(ee.color)
      .setURL("https://discord.com/api/oauth2/authorize?client_id=914037041673682995&permissions=8&scope=bot")
      .setTitle("❤ | Thanks for every invite!")
      .setDescription(`[Click here to invite me, thanks](https://discord.com/api/oauth2/authorize?client_id=914037041673682995&permissions=8&scope=bot)`)
      .setFooter(ee.footertext, ee.footericon)
    )
    ...
    message.reply(
      ...
      .setColor(ee.color)
      .setFooter(ee.footertext, ee.footericon)
      .setAuthor(`${client.user.username}'s' Source Code`, client.user.displayAvatarURL(), " ")
      .setTitle(`This Bot is made by \`Chauvin#4522\` and **this** is the Source Code link to this Bot`)
      .setURL("https://github.com/FarmerChauvin")
      ...
      .addField("Source Code. ", "Don't just use the source for yourself,... please [invite](https://discord.com/api/oauth2/authorize?client_id=914037041673682995&permissions=8&scope=bot) me too![\`Click here\`](https://github.com/FarmerChauvin)")
