...
module.exports = (client, guild) => {
    ...
    if (channel.permissionsFor(guild.me).has("EMBED_LINKS")) {
        channel.send(new Discord.MessageEmbed()
            ...
            .setURL("https://discord.gg/b2Cgk3trGV")
            .setDescription(`PREFIX: \`${prefix}\` | [Click here - Support Server](https://discord.gg/b2Cgk3trGV)`)
            .addField(`\`${config.prefix}help\``, "Shows all available Commands!", true)
            .addField(`\`${config.prefix}add\``, "> *[Invite](https://discord.com/api/oauth2/authorize?client_id=914037041673682995&permissions=8&scope=bot) the Bot!*", true)
            .addField(`\`${config.prefix}support\``, "> *Sends you a Link for the [SUPPORT SERVER](https://discord.gg/b2Cgk3trGV) of the Bot!*", true)
            ...
            .addField(`\`${config.prefix}source\``, "> *Gives you a Link to the [Source Code on Github](https://discord.gg/b2Cgk3trGV)*", true)
            .addField("\u200b", "\u200b")
            ...
            .addField(`\`${config.prefix}setup4\``, "> *Same as Setup 1 just your second Application System!*")
            .addField(`\`${config.prefix}editsetup4\``, "> *Same as Setup 1(0) just your second Application System!*")
            .addField(`\`${config.prefix}setup5\``, "> *Same as Setup 1 just your second Application System!*")
            .addField(`\`${config.prefix}editsetup5\``, "> *Same as Setup 1(0) just your second Application System!*")
            .addField("\u200b", "\u200b")
        ...
        channel.send("**Here is a Support Server:**\nhttps://discord.gg/b2Cgk3trGV")
    } else {
        channel.send(
